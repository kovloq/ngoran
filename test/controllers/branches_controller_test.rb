...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, latitude: @branch.latitude, longitude: @branch.longitude, name: @branch.name }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, latitude: @branch.latitude, longitude: @branch.longitude, name: @branch.name }
    assert_redirected_to branch_path(assigns(:branch))
  end
